  ...
  const projects = [
    {
      ...
      description: 'Smart productivity app with natural language processing for task creation and intelligent scheduling.',
      image: '/placeholder.svg',
      category: 'AI Tools',
      tech: ['React', 'Python', 'OpenAI API', 'PostgreSQL'],
      problem: 'Traditional task managers are clunky and time-consuming',
      process: 'Built NLP pipeline for natural task input and AI-driven scheduling',
      solution: 'Intuitive voice/text input with intelligent priority and time suggestions',
    ...
    },
    {
      ...
      description: 'Real-time dashboard tracking SpaceX missions with detailed analytics and countdown timers.',
      image: '/placeholder.svg',
      category: 'Web Apps',
      tech: ['Next.js', 'TypeScript', 'SpaceX API', 'Chart.js'],
      problem: 'Scattered information about space launches across multiple sources',
      process: 'Integrated multiple APIs and created unified data visualization',
      solution: 'Centralized dashboard with real-time updates and rich analytics',
    ...
    },
    {
      ...
      description: 'Accessible, customizable UI components with comprehensive documentation and Storybook integration.',
      image: '/placeholder.svg',
      category: 'Open Source',
      tech: ['React', 'TypeScript', 'Storybook', 'Rollup'],
      problem: 'Lack of accessible, well-documented React components',
      process: 'Built with accessibility-first approach and comprehensive testing',
    ...
    },
    {
      ...
      description: 'Mobile-first web app for tracking workouts, nutrition, and progress with data visualization.',
      image: '/placeholder.svg',
      category: 'Web Apps',
      ...
      solution: 'Simple tracking with powerful analytics and progress visualization',
    ...
    },
    {
      ...
      description: 'Conversational weather app that provides personalized recommendations based on conditions.',
      image: '/placeholder.svg',
      category: 'AI Tools',
      ...
      solution: 'Conversational interface that suggests activities and clothing',
    ...
    },
    {
      ...
      description: 'Developer tool for organizing, searching, and sharing code snippets with team collaboration features.',
      image: '/placeholder.svg',
      category: 'Web Apps',
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 scroll-reveal">
            ...
            {/* Filter Buttons */}
            <div className="flex flex-wrap justify-center gap-2 scroll-reveal" style={{ animationDelay: '0.2s' }}>
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="space-y-3 mb-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="text-muted-foreground ml-2">{project.impact}</span>
                    </div>
                  </div>
          ...
          {/* View More */}
          <div className="text-center mt-12 scroll-reveal" style={{ animationDelay: '0.8s' }}>
            <Button variant="outline" className="px-8 py-3 hover:scale-105 transition-all duration-300">
